...
class IzinDocumentService
{
    private const DISK = 'local';

    private const DIR = 'dokumen/izin';
    ...
    public function delete(?string $filename): void
    {
        ...
        Storage::disk('public')->delete('dokumen/izin/'.$filename);
    }
    ...
    public function exists(string $filename): bool
    {
        ...
        return Storage::disk(self::DISK)->exists(self::DIR.'/'.$filename)
            || Storage::disk('public')->exists('dokumen/izin/'.$filename);
    }
