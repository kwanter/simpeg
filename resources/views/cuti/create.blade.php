                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cuti.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_pegawai" value="{{ $pegawai->nama }}" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('jenis_cuti') is-invalid @enderror" id="jenis_cuti" name="jenis_cuti" required>
                                ...
                                @foreach($jenisCuti as $jenis)
                                    <option value="{{ $jenis }}" {{ old('jenis_cuti') == $jenis ? 'selected' : '' }}>{{ $jenis }}</option>
                                @endforeach
                            </select>
                            @error('jenis_cuti')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('alamat_selama_cuti') is-invalid @enderror" id="alamat_selama_cuti" name="alamat_selama_cuti" rows="2" required>{{ old('alamat_selama_cuti') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('no_hp_selama_cuti') is-invalid @enderror" id="no_hp_selama_cuti" name="no_hp_selama_cuti" value="{{ old('no_hp_selama_cuti') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Opsional. Upload dokumen pendukung jika diperlukan.</small>
                            @error('dokumen')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
