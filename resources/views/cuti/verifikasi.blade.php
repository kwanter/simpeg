        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <h5 class="card-title mb-0">Form Verifikasi</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('cuti.proses-verifikasi', $cuti->uuid) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status_verifikator" id="status_ditolak" value="Ditolak" required>
                                            <label class="form-check-label" for="status_ditolak">
                                                Ditolak
                                            </label>
                                        </div>
                                    </div>
                                    @error('status_verifikator')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>

                                <div class="mb-3">
                                    <label for="catatan_verifikator" class="form-label">Catatan Verifikasi</label>
                                    <textarea name="catatan_verifikator" id="catatan_verifikator" rows="3" class="form-control"></textarea>
